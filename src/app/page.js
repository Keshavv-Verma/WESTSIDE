...
export default function Home( ) {
  ...
  return (
   ...
   ;s=d.createElement("script");s.src="https://client.crisp.chat/l.js";s.async=1;d.getElementsByTagName("head")[0].appendChild(s)})();</Script> */}
    ...
    <div className="h-screen bg-[url('https://www.westside.com/cdn/shop/files/DRESSES_Web_1a5a76c9-40a9-4747-bb81-dcf0b75e2903.jpg?v=1711699516')] bg-center bg-cover">
   </div>
    ...
    <div className="h-screen bg-[url('https://www.westside.com/cdn/shop/files/SHIRTS_TOPS_Web.jpg?v=1711693114')] bg-center bg-cover">
   </div>
    <div className="h-screen bg-[url('https://www.westside.com/cdn/shop/files/GIRLS_Web_261bee62-4fd5-41f8-bb6b-0ea24ff7c566.jpg?v=1711790532')] bg-center bg-cover">
   </div>
