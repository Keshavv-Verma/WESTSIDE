...
const ProductShow = (outlet) => {
  // console.log("My Outlet is is is is is is:",outlet);
  function useHorizontalScroll() {
    ...
    let rateArray=(outlet.outlet)['rateArray']
    let reqmail=(outlet.outlet)['reqmail']
    // console.log("My Rate Array is:::::::::::",rateArray);
    let type=((outlet.outlet).outData)['slug']['fashion-name']
    
    let similar=(outlet.outlet).fetchSimilar
    similar=similar.slice(0,5);
    let prop=outcome
    let revArray=prop['reviews']
